...
We all know JSON, YAML, and TOML. They're popular configuration languages. They're great,
don't get me wrong, but I wanted something different, something a bit more simple, readable, uniform, and
...
make my own configuration language, LQF, the Lightweight Quick Format,
...
LQF supports a lot of values, when assigning a key to a value.
Read the table below for more info:
...
It's **simple**, **readable**, and looks **awesome** (in my opinion).
